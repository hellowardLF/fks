...
import tv.qishi.milian.home.adapter.LatestRecyclerListAdapter;
import tv.qishi.milian.home.adapter.TopicRecyclerListAdapter;
import tv.qishi.milian.home.intf.OnRecyclerViewItemClickListener;
import tv.qishi.milian.home.model.TopicItem;
import tv.qishi.milian.home.model.VideoItem;
import tv.qishi.milian.home.view.SpaceItemDecoration;
import tv.qishi.milian.intf.OnCustomClickListener;
...
import tv.qishi.milian.utils.DialogEnsureUtiles;
...
//        manager.setOrientation(LinearLayoutManager.VERTICAL);
        ...
        mRecyclerViewTopic.setLayoutManager(manager2);
        ...
        if(StringUtils.isNotEmpty(item.getPrice()) && Integer.parseInt(item.getPrice())>0){
            DialogEnsureUtiles.showConfirm(getActivity(), "该房间需要收费" + item.getPrice()+"/分钟", new OnCustomClickListener() {
                ...
                public void onClick(String value) {
                    ...
                    Log.i(TAG, "onClick: "+app.getBalance());
                    if (app.getBalance()==null){
                        toast("余额不足，请充值");
                        return;
                    }else if (app.getBalance()!=null){
