...
import tv.qishi.milian.kuaishou.PaoPaoActivity;
        ...
        Api.doLogin(this, params, new OnRequestDataListener() {
            ...
            public void requestSuccess(int code, JSONObject data) {
                ...
                if (token != null) {
                    ...
                    if ((Boolean) SharePrefsUtils.get(LoginByPhoneActivity.this,"user",
                            PaoPaoActivity.TAG,true)){
                        openActivity(PaoPaoActivity.class);
                    }else
