...
//        LogUtil.i("info", "getScreenWidth" + dm.widthPixels);
    ...
    //重新测量高度
    public static void reHeight(Activity mContext,View v,int mul){
        RelativeLayout.LayoutParams mParams=new RelativeLayout.LayoutParams(getScreenWidth(mContext),
                getScreenWidth(mContext)/mul);
